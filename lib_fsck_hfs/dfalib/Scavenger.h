...
typedef int (*UserCancelProcPtr)(UInt16 progress, UInt16 secondsRemaining, Boolean progressChanged, UInt16 stage, lib_fsck_ctx_t context, int passno);
...
typedef struct SGlob {
	...
	Boolean			guiControl;
	lib_fsck_ctx_t	context;
    fsck_ctx_t      messagesContext;
	int				chkLevel;
	int             repairLevel;
